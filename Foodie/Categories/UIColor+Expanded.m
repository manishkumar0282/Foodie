//https://github.com/erica/uicolor-utilities/blob/master/Color/UIColor%2BExpanded.m
...
+ (UIColor *) colorWithString: (NSString *)stringToConvert
{
    ...
    float v1 = c[i++];
    if (![scanner scanFloat: &v1]) return nil;
    ...
    while (1)
    {
        ...
        {
            float v2 = c[i++];
            if (![scanner scanFloat: &v2]) return nil;
        }
        else
        {
...
- (CGFloat) colorTemperature
{
    ...
    {
        UIColor *color = [UIColor colorWithRGB:hexKey];
...
+ (UIColor *) colorWithRGB: (NSString *)stringToConvert
{
...
+ (UIColor *) colorWithRGBA:(NSString *)stringToConvert
{
...
+ (UIColor *) colorWithName: (NSString *) name inDictionary: (NSString *) dictionaryName
{
    ...
    return [UIColor colorWithRGB:hexkey];
}
...
- (NSString *) closestColorNameUsingDictionary: (NSString *) dictionaryName
{
    ...
    for (NSString *colorName in colorDictionary.allKeys)
    {
        ...
        UIColor *comparisonColor = [UIColor colorWithRGB:colorHex];
        if (!comparisonColor)
            continue;
